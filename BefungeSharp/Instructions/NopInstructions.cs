...
namespace BefungeSharp.Instructions.Nop
{
    ...
    {
        public NopInstruction(char inName, int minimum_flags) : base(inName, CommandType.Nop, minimum_flags) { }
    }

    public class SpaceInstruction : NopInstruction
    {
        public SpaceInstruction(char inName, int minimum_flags) : base(inName, minimum_flags) { this.color = ConsoleColor.Black; }
    ...
    {
        public ExplicitNopInstruction(char inName, int minimum_flags) : base(inName, minimum_flags) { }
